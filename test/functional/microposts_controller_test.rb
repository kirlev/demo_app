...
class MicropostsControllerTest < ActionController::TestCase
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post :create, micropost: { content: @micropost.content, user_int: @micropost.user_int }
    end
  ...
  test "should update micropost" do
    put :update, id: @micropost, micropost: { content: @micropost.content, user_int: @micropost.user_int }
    assert_redirected_to micropost_path(assigns(:micropost))
  end
